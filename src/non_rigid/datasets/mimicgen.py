...
class MimicGenDataset(data.Dataset):
...
class MimicGenDataModule(L.LightningDataModule):
    ...
    def setup(self, stage: str = "fit"):
        ...
        self.train_dataset = MimicGenDataset(self.root, self.dataset_cfg, "train_tax3d")
        self.val_dataset = MimicGenDataset(self.root, self.dataset_cfg, "val_tax3d")
